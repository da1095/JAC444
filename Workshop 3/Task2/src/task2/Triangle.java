...
public class Triangle extends GeometricObject {
    ...
    this.side3=1.0;
     ...
     public Triangle(double side1,double side2, double side3,String color,boolean fill) throws TriangleException{
     super(color,fill);    
    this.side1=side1;
    this.side2=side2;
    this.side3=side3;
    this.triangleValidator(side1, side2, side3);
    
    
    }
     public void triangleValidator(double side1,double side2,double side3) throws TriangleException{
